(function(){
    ...
    Query.prototype.distinct = function(compareSelector){
        this.steps.push({ op: 'distinct', args: { selector: utility.createLambda(compareSelector) } });
        return this;
    };
    ...
    Query.prototype.toLookup = function(keySelector, elementSelector, compareSelector, callback){
        var iterator = this.toIterator();
        iterator.toLookup(keySelector, elementSelector, compareSelector, callback);
    };
